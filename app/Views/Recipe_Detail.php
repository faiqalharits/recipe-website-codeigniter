...
<head>
  ...
  <style>
    ...
    .hero-gradient {
      background: linear-gradient(to top, rgba(12, 10, 9, 1) 0%, rgba(12, 10, 9, 0.4) 50%, rgba(12, 10, 9, 0.2) 100%);
    }
...
<body class="bg-background-light dark:bg-background-dark text-stone-800 dark:text-stone-200 transition-colors duration-300">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
        <div class="flex items-center gap-3">
          ...
          <div>
            <p class="text-xs uppercase tracking-wider text-stone-500 font-bold">Prep Time</p>
            <p class="font-bold">15 Mins</p>
          </div>
        </div>
        <div class="flex items-center gap-3">
          <div class="p-2 rounded-lg bg-stone-200 dark:bg-stone-800 text-primary"><span class="material-icons-outlined">timer</span></div>
          <div>
            <p class="text-xs uppercase tracking-wider text-stone-500 font-bold">Cook Time</p>
            <p class="font-bold">10 Mins</p>
          </div>
        </div>
        <div class="flex items-center gap-3">
          ...
          <div>
            <p class="text-xs uppercase tracking-wider text-stone-500 font-bold">Difficulty</p>
        ...
        <div class="flex items-center gap-3">
          ...
          <div>
            <p class="text-xs uppercase tracking-wider text-stone-500 font-bold">Servings</p>
            <p class="font-bold">4 People</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <section class="prose prose-stone dark:prose-invert max-w-none">
          ...
          <div class="space-y-12">
            <div class="flex gap-6">
              ...
              <div>
                <h4 class="text-xl font-bold mb-2">Prepare the Sauce</h4>
                <p class="text-stone-600 dark:text-stone-400 leading-relaxed">In a small bowl, whisk together the soy sauce, grated ginger, minced garlic, and Szechuan chili oil. If you prefer a thicker sauce, add half a teaspoon of cornstarch to the mixture.</p>
              </div>
            </div>
            <div class="flex gap-6">
              ...
              <div>
                <h4 class="text-xl font-bold mb-2">Blanch the Broccoli</h4>
                <p class="text-stone-600 dark:text-stone-400 leading-relaxed">Bring a pot of salted water to a boil. Briefly blanch the broccoli florets for 2 minutes until bright green but still crisp. Immediately plunge them into ice water to stop the cooking process. Drain and set aside.</p>
              </div>
            </div>
            <div class="flex gap-6">
              ...
              <div>
                <h4 class="text-xl font-bold mb-2">Sear the Shrimp</h4>
                <p class="text-stone-600 dark:text-stone-400 leading-relaxed">Heat a wok or large skillet over high heat with a tablespoon of vegetable oil. Once shimmering, add the shrimp in a single layer. Sear for 1-2 minutes per side until pink and slightly charred.</p>
              </div>
            </div>
            <div class="flex gap-6">
              ...
              <div>
                <h4 class="text-xl font-bold mb-2">Combine and Finish</h4>
                <p class="text-stone-600 dark:text-stone-400 leading-relaxed">Add the blanched broccoli to the wok with the shrimp. Pour the prepared sauce over the mixture. Toss continuously for 1-2 minutes until the sauce has thickened and coated everything evenly.</p>
              </div>
            </div>
            <div class="flex gap-6">
              ...
              <div>
                <h4 class="text-xl font-bold mb-2">Garnish and Serve</h4>
                <p class="text-stone-600 dark:text-stone-400 leading-relaxed">Remove from heat. Sprinkle with sesame seeds and fresh scallions if desired. Serve immediately over jasmine rice or rice noodles.</p>
              </div>
            </div>
          </div>
        </section>
  ...
  <script>
    ...
    function submitComment() {
      ...
      if (rating === 0) {
        showError('Pilih rating bintang dulu ya!');
        return;
      }
      if (!text) {
